...
vkiApplicationInfo(const char* pApplicationName,
...
vkiInstanceCreateInfo(const VkApplicationInfo* pApplicationInfo,
...
inline VkPhysicalDeviceFeatures
vkiPhysicalDeviceFeatures(VkBool32 robustBufferAccess,
...
inline VkExtent3D
vkiExtent3D(uint32_t width, uint32_t height, uint32_t depth)
{
  VkExtent3D Extent3D = {};
...
inline VkImageFormatProperties
vkiImageFormatProperties(VkExtent3D maxExtent,
...
inline VkPhysicalDeviceSparseProperties
vkiPhysicalDeviceSparseProperties(
...
vkiQueueFamilyProperties(VkQueueFlags queueFlags,
                         uint32_t queueCount,
...
inline VkMemoryType
vkiMemoryType(VkMemoryPropertyFlags propertyFlags, uint32_t heapIndex)
{
...
inline VkMemoryHeap
vkiMemoryHeap(VkDeviceSize size)
{
...
vkiDeviceQueueCreateInfo(uint32_t queueFamilyIndex,
                         uint32_t queueCount,
...
vkiDeviceCreateInfo(uint32_t queueCreateInfoCount,
...
inline VkSubmitInfo
vkiSubmitInfo(uint32_t waitSemaphoreCount,
...
vkiMemoryAllocateInfo(VkDeviceSize allocationSize, uint32_t memoryTypeIndex)
{
...
vkiMappedMemoryRange(VkDeviceMemory memory,
                     VkDeviceSize offset,
                     VkDeviceSize size)
{
...
vkiMemoryRequirements(VkDeviceSize size,
...
inline VkSparseImageMemoryRequirements
vkiSparseImageMemoryRequirements(VkSparseImageFormatProperties formatProperties,
...
vkiSparseMemoryBind(VkDeviceSize resourceOffset,
                    VkDeviceSize size,
...
vkiSparseBufferMemoryBindInfo(VkBuffer buffer,
                              uint32_t bindCount,
...
vkiSparseImageOpaqueMemoryBindInfo(VkImage image,
                                   uint32_t bindCount,
                                   const VkSparseMemoryBind* pBinds)
{
...
vkiImageSubresource(VkImageAspectFlags aspectMask,
                    uint32_t mipLevel,
                    uint32_t arrayLayer)
{
...
inline VkOffset3D
vkiOffset3D(int32_t x, int32_t y, int32_t z)
{
  VkOffset3D Offset3D = {};
  Offset3D.x = x;
  Offset3D.y = y;
...
vkiSparseImageMemoryBind(VkImageSubresource subresource,
                         VkOffset3D offset,
                         VkExtent3D extent,
                         VkDeviceMemory memory,
                         VkDeviceSize memoryOffset)
...
vkiSparseImageMemoryBindInfo(VkImage image,
                             uint32_t bindCount,
...
vkiBindSparseInfo(uint32_t waitSemaphoreCount,
                  const VkSemaphore* pWaitSemaphores,
...
vkiQueryPoolCreateInfo(VkQueryType queryType,
                       uint32_t queryCount,
...
vkiBufferCreateInfo(VkDeviceSize size,
...
inline VkBufferViewCreateInfo
vkiBufferViewCreateInfo(VkBuffer buffer,
                        VkFormat format,
                        VkDeviceSize offset,
                        VkDeviceSize range)
{
...
vkiImageCreateInfo(VkImageType imageType,
                   VkFormat format,
                   VkExtent3D extent,
                   uint32_t mipLevels,
...
vkiSubresourceLayout(VkDeviceSize offset,
                     VkDeviceSize size,
...
inline VkComponentMapping
vkiComponentMapping(VkComponentSwizzle r,
...
vkiImageSubresourceRange(VkImageAspectFlags aspectMask,
...
vkiImageViewCreateInfo(VkImage image,
...
vkiPipelineShaderStageCreateInfo(
...
vkiVertexInputBindingDescription(uint32_t binding,
                                 uint32_t stride,
...
vkiVertexInputAttributeDescription(uint32_t location,
                                   uint32_t binding,
                                   VkFormat format,
                                   uint32_t offset)
{
...
inline VkOffset2D
vkiOffset2D(int32_t x, int32_t y)
{
  VkOffset2D Offset2D = {};
  Offset2D.x = x;
  Offset2D.y = y;
...
inline VkExtent2D
vkiExtent2D(uint32_t width, uint32_t height)
{
  VkExtent2D Extent2D = {};
...
inline VkRect2D
vkiRect2D(VkOffset2D offset, VkExtent2D extent)
{
  VkRect2D Rect2D = {};
...
vkiPipelineViewportStateCreateInfo(uint32_t viewportCount,
...
vkiPipelineRasterizationStateCreateInfo(VkBool32 depthClampEnable,
...
vkiStencilOpState(VkStencilOp failOp,
                  VkStencilOp passOp,
...
vkiPipelineDepthStencilStateCreateInfo(VkBool32 depthTestEnable,
...
vkiPipelineColorBlendAttachmentState(VkBool32 blendEnable,
...
vkiComputePipelineCreateInfo(VkPipelineShaderStageCreateInfo stage,
                             VkPipelineLayout layout,
                             VkPipeline basePipelineHandle,
                             int32_t basePipelineIndex)
{
...
vkiPushConstantRange(VkShaderStageFlags stageFlags,
                     uint32_t offset,
                     uint32_t size)
{
...
vkiSamplerCreateInfo(VkFilter magFilter,
                     VkFilter minFilter,
...
vkiDescriptorSetLayoutBinding(uint32_t binding,
...
vkiDescriptorSetLayoutCreateInfo(uint32_t bindingCount,
...
vkiDescriptorPoolSize(VkDescriptorType type, uint32_t descriptorCount)
{
...
vkiDescriptorPoolCreateInfo(uint32_t maxSets,
...
vkiDescriptorImageInfo(VkSampler sampler,
...
vkiDescriptorBufferInfo(VkBuffer buffer,
                        VkDeviceSize offset,
                        VkDeviceSize range)
{
...
vkiWriteDescriptorSet(VkDescriptorSet dstSet,
                      uint32_t dstBinding,
...
vkiCopyDescriptorSet(VkDescriptorSet srcSet,
                     uint32_t srcBinding,
...
vkiFramebufferCreateInfo(VkRenderPass renderPass,
...
vkiAttachmentDescription(VkFormat format,
                         VkSampleCountFlagBits samples,
...
vkiAttachmentReference(uint32_t attachment, VkImageLayout layout)
{
...
vkiSubpassDescription(VkPipelineBindPoint pipelineBindPoint,
...
vkiSubpassDependency(uint32_t srcSubpass,
                     uint32_t dstSubpass,
...
vkiRenderPassCreateInfo(uint32_t attachmentCount,
...
vkiCommandBufferInheritanceInfo(
  VkRenderPass renderPass,
  uint32_t subpass,
...
inline VkBufferCopy
vkiBufferCopy(VkDeviceSize srcOffset, VkDeviceSize dstOffset, VkDeviceSize size)
{
...
vkiImageSubresourceLayers(VkImageAspectFlags aspectMask,
                          uint32_t mipLevel,
                          uint32_t baseArrayLayer,
                          uint32_t layerCount)
{
...
inline VkImageCopy
vkiImageCopy(VkImageSubresourceLayers srcSubresource,
...
vkiBufferImageCopy(VkDeviceSize bufferOffset,
...
inline VkClearDepthStencilValue
vkiClearDepthStencilValue(float depth, uint32_t stencil)
{
...
inline VkClearAttachment
vkiClearAttachment(VkImageAspectFlags aspectMask,
...
inline VkClearRect
vkiClearRect(VkRect2D rect, uint32_t baseArrayLayer, uint32_t layerCount)
{
...
inline VkImageResolve
vkiImageResolve(VkImageSubresourceLayers srcSubresource,
                VkOffset3D srcOffset,
                VkImageSubresourceLayers dstSubresource,
                VkOffset3D dstOffset,
                VkExtent3D extent)
...
vkiMemoryBarrier(VkAccessFlags srcAccessMask, VkAccessFlags dstAccessMask)
{
...
vkiBufferMemoryBarrier(VkAccessFlags srcAccessMask,
                       VkAccessFlags dstAccessMask,
...
vkiImageMemoryBarrier(VkAccessFlags srcAccessMask,
                      VkAccessFlags dstAccessMask,
...
vkiRenderPassBeginInfo(VkRenderPass renderPass,
                       VkFramebuffer framebuffer,
                       VkRect2D renderArea,
...
vkiDrawIndexedIndirectCommand(uint32_t indexCount,
...
inline VkDrawIndirectCommand
vkiDrawIndirectCommand(uint32_t vertexCount,
                       uint32_t instanceCount,
...
vkiBindBufferMemoryInfo(VkBuffer buffer,
                        VkDeviceMemory memory,
                        VkDeviceSize memoryOffset)
{
...
inline VkBindImageMemoryInfo
vkiBindImageMemoryInfo(VkImage image,
                       VkDeviceMemory memory,
                       VkDeviceSize memoryOffset)
{
...
inline VkDeviceGroupSubmitInfo
vkiDeviceGroupSubmitInfo(uint32_t waitSemaphoreCount,
...
vkiSparseImageMemoryRequirements2(
...
vkiPhysicalDeviceImageFormatInfo2(VkFormat format,
                                  VkImageType type,
                                  VkImageTiling tiling,
                                  VkImageUsageFlags usage)
{
...
inline VkPhysicalDeviceMemoryProperties2
vkiPhysicalDeviceMemoryProperties2(
...
vkiPhysicalDeviceSparseImageFormatInfo2(VkFormat format,
                                        VkImageType type,
                                        VkSampleCountFlagBits samples,
                                        VkImageUsageFlags usage,
                                        VkImageTiling tiling)
...
inline VkRenderPassMultiviewCreateInfo
vkiRenderPassMultiviewCreateInfo(uint32_t subpassCount,
...
inline VkDeviceQueueInfo2
vkiDeviceQueueInfo2(uint32_t queueFamilyIndex, uint32_t queueIndex)
{
...
inline VkProtectedSubmitInfo
vkiProtectedSubmitInfo(VkBool32 protectedSubmit)
{
...
inline VkSamplerYcbcrConversionCreateInfo
vkiSamplerYcbcrConversionCreateInfo(VkFormat format,
...
vkiPhysicalDeviceSamplerYcbcrConversionFeatures(VkBool32 samplerYcbcrConversion)
{
...
inline VkDescriptorUpdateTemplateEntry
vkiDescriptorUpdateTemplateEntry(uint32_t dstBinding,
                                 uint32_t dstArrayElement,
                                 uint32_t descriptorCount,
                                 VkDescriptorType descriptorType,
                                 size_t offset,
...
inline VkExternalMemoryProperties
vkiExternalMemoryProperties(
...
inline VkExternalImageFormatProperties
vkiExternalImageFormatProperties(
  VkExternalMemoryProperties externalMemoryProperties)
{
...
inline VkPhysicalDeviceExternalBufferInfo
vkiPhysicalDeviceExternalBufferInfo(
  VkBufferUsageFlags usage,
  VkExternalMemoryHandleTypeFlagBits handleType)
{
...
inline VkExternalBufferProperties
vkiExternalBufferProperties(VkExternalMemoryProperties externalMemoryProperties)
{
...
inline VkPhysicalDeviceExternalFenceInfo
vkiPhysicalDeviceExternalFenceInfo(VkExternalFenceHandleTypeFlagBits handleType)
{
...
inline VkExternalFenceProperties
vkiExternalFenceProperties(
...
inline VkExternalSemaphoreProperties
vkiExternalSemaphoreProperties(
...
vkiSurfaceCapabilitiesKHR(uint32_t minImageCount,
...
vkiSurfaceFormatKHR(VkFormat format, VkColorSpaceKHR colorSpace)
{
...
vkiSwapchainCreateInfoKHR(VkSurfaceKHR surface,
...
inline VkPresentInfoKHR
vkiPresentInfoKHR(uint32_t waitSemaphoreCount,
                  const VkSemaphore* pWaitSemaphores,
...
vkiAcquireNextImageInfoKHR(VkSwapchainKHR swapchain,
                           uint64_t timeout,
...
inline VkDisplayPropertiesKHR
vkiDisplayPropertiesKHR(VkDisplayKHR display,
...
inline VkDisplayPlaneCapabilitiesKHR
vkiDisplayPlaneCapabilitiesKHR(VkDisplayPlaneAlphaFlagsKHR supportedAlpha,
...
inline VkDisplaySurfaceCreateInfoKHR
vkiDisplaySurfaceCreateInfoKHR(VkDisplayModeKHR displayMode,
                               uint32_t planeIndex,
...
inline VkDisplayPresentInfoKHR
vkiDisplayPresentInfoKHR(VkRect2D srcRect,
                         VkRect2D dstRect,
                         VkBool32 persistent)
{
...
vkiImportMemoryFdInfoKHR(VkExternalMemoryHandleTypeFlagBits handleType, int fd)
{
...
inline VkRectLayerKHR
vkiRectLayerKHR(VkOffset2D offset, VkExtent2D extent, uint32_t layer)
{
...
vkiPresentRegionKHR(uint32_t rectangleCount, const VkRectLayerKHR* pRectangles)
{
...
vkiPhysicalDeviceImagelessFramebufferFeaturesKHR(VkBool32 imagelessFramebuffer)
{
...
vkiFramebufferAttachmentImageInfoKHR(VkImageUsageFlags usage,
                                     uint32_t width,
                                     uint32_t height,
                                     uint32_t layerCount,
...
inline VkAttachmentDescription2KHR
vkiAttachmentDescription2KHR(VkFormat format,
                             VkSampleCountFlagBits samples,
                             VkAttachmentLoadOp loadOp,
                             VkAttachmentStoreOp storeOp,
                             VkAttachmentLoadOp stencilLoadOp,
...
vkiAttachmentReference2KHR(uint32_t attachment,
...
inline VkSubpassDescription2KHR
vkiSubpassDescription2KHR(
  VkPipelineBindPoint pipelineBindPoint,
  uint32_t viewMask,
  uint32_t inputAttachmentCount,
...
inline VkSubpassDependency2KHR
vkiSubpassDependency2KHR(uint32_t srcSubpass,
                         uint32_t dstSubpass,
                         VkPipelineStageFlags srcStageMask,
                         VkPipelineStageFlags dstStageMask,
                         VkAccessFlags srcAccessMask,
...
inline VkRenderPassCreateInfo2KHR
vkiRenderPassCreateInfo2KHR(uint32_t attachmentCount,
...
inline VkSubpassEndInfoKHR
vkiSubpassEndInfoKHR()
{
...
inline VkDisplayPlaneProperties2KHR
vkiDisplayPlaneProperties2KHR(
...
inline VkDisplayPlaneInfo2KHR
vkiDisplayPlaneInfo2KHR(VkDisplayModeKHR mode, uint32_t planeIndex)
{
...
vkiPhysicalDeviceShaderAtomicInt64FeaturesKHR(VkBool32 shaderBufferInt64Atomics,
...
inline VkConformanceVersionKHR
vkiConformanceVersionKHR(uint8_t major,
                         uint8_t minor,
                         uint8_t subminor,
                         uint8_t patch)
{
...
vkiSemaphoreWaitInfoKHR(uint32_t semaphoreCount,
...
inline VkSemaphoreSignalInfoKHR
vkiSemaphoreSignalInfoKHR(VkSemaphore semaphore, uint64_t value)
{
...
inline VkPipelineInfoKHR
vkiPipelineInfoKHR(VkPipeline pipeline)
{
...
vkiTextureLODGatherFormatPropertiesAMD(VkBool32 supportsTextureGatherLODBiasAMD)
{
...
vkiShaderResourceUsageAMD(uint32_t numUsedVgprs,
...
inline VkExternalImageFormatPropertiesNV
vkiExternalImageFormatPropertiesNV(
  VkImageFormatProperties imageFormatProperties,
...
inline VkExternalMemoryImageCreateInfoNV
vkiExternalMemoryImageCreateInfoNV(
...
vkiSurfaceCapabilities2EXT(uint32_t minImageCount,
                           uint32_t maxImageCount,
                           VkExtent2D currentExtent,
                           VkExtent2D minImageExtent,
                           VkExtent2D maxImageExtent,
...
vkiPastPresentationTimingGOOGLE(uint32_t presentID,
...
inline VkPresentTimeGOOGLE
vkiPresentTimeGOOGLE(uint32_t presentID, uint64_t desiredPresentTime)
{
...
inline VkViewportSwizzleNV
vkiViewportSwizzleNV(VkViewportCoordinateSwizzleNV x,
...
vkiDebugUtilsObjectNameInfoEXT(VkObjectType objectType,
...
vkiDebugUtilsObjectTagInfoEXT(VkObjectType objectType,
                              uint64_t objectHandle,
                              uint64_t tagName,
                              size_t tagSize,
                              const void* pTag)
...
vkiDebugUtilsMessengerCreateInfoEXT(
...
vkiWriteDescriptorSetInlineUniformBlockEXT(uint32_t dataSize, const void* pData)
{
...
inline VkSampleLocationEXT
vkiSampleLocationEXT(float x, float y)
{
...
vkiPipelineColorBlendAdvancedStateCreateInfoEXT(VkBool32 srcPremultiplied,
...
inline VkDrmFormatModifierPropertiesEXT
vkiDrmFormatModifierPropertiesEXT(
...
vkiImageDrmFormatModifierListCreateInfoEXT(uint32_t drmFormatModifierCount,
...
inline VkShadingRatePaletteNV
vkiShadingRatePaletteNV(
...
inline VkRayTracingShaderGroupCreateInfoNV
vkiRayTracingShaderGroupCreateInfoNV(VkRayTracingShaderGroupTypeNV type,
...
vkiRayTracingPipelineCreateInfoNV(
  uint32_t stageCount,
  const VkPipelineShaderStageCreateInfo* pStages,
  uint32_t groupCount,
...
inline VkGeometryTrianglesNV
vkiGeometryTrianglesNV(VkBuffer vertexData,
...
inline VkGeometryAABBNV
vkiGeometryAABBNV(VkBuffer aabbData,
                  uint32_t numAABBs,
                  uint32_t stride,
                  VkDeviceSize offset)
{
...
inline VkGeometryDataNV
vkiGeometryDataNV(VkGeometryTrianglesNV triangles, VkGeometryAABBNV aabbs)
{
...
inline VkGeometryNV
vkiGeometryNV(VkGeometryTypeNV geometryType, VkGeometryDataNV geometry)
{
...
vkiPhysicalDeviceShaderCorePropertiesAMD(uint32_t shaderEngineCount,
...
vkiPhysicalDeviceMeshShaderFeaturesNV(VkBool32 taskShader, VkBool32 meshShader)
{
...
inline VkQueueFamilyCheckpointPropertiesNV
vkiQueueFamilyCheckpointPropertiesNV(
...
inline VkCheckpointDataNV
vkiCheckpointDataNV(VkPipelineStageFlagBits stage, void* pCheckpointMarker)
{
...
inline VkQueryPoolCreateInfoINTEL
vkiQueryPoolCreateInfoINTEL(
...
vkiPhysicalDevicePCIBusInfoPropertiesEXT(uint32_t pciDomain,
                                         uint32_t pciBus,
                                         uint32_t pciDevice,
...
inline VkValidationFeaturesEXT
vkiValidationFeaturesEXT(
...
inline VkCooperativeMatrixPropertiesNV
vkiCooperativeMatrixPropertiesNV(uint32_t MSize,
                                 uint32_t NSize,
                                 uint32_t KSize,
...
vkiPhysicalDeviceCoverageReductionModeFeaturesNV(VkBool32 coverageReductionMode)
{
...
inline VkHeadlessSurfaceCreateInfoEXT
vkiHeadlessSurfaceCreateInfoEXT()
{
...
vkiPhysicalDeviceTexelBufferAlignmentFeaturesEXT(VkBool32 texelBufferAlignment)
{
